...
class DataTransformation:
    ...
    def get_data_transformation_obj(self):
        try:
            logging.info('Data Transformation Started and getting Preprocessor object')
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info('train and test data has been read successfully')
            ...
            logging.info('Mapping the target classes')
            ...
            drop_column_names=[target_column_name,'fnlwgt','country']

            input_feature_train_df = train_df.drop(columns=drop_column_names,axis=1)
            target_feature_train_df = train_df[target_column_name]

            input_feature_test_df=test_df.drop(columns=drop_column_names,axis=1)
